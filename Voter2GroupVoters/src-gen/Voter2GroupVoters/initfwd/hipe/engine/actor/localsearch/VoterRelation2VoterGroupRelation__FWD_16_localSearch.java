...
public class VoterRelation2VoterGroupRelation__FWD_16_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__FWD_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__FWD_17": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__FWD_19": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__FWD_21": 
				if(true) {
