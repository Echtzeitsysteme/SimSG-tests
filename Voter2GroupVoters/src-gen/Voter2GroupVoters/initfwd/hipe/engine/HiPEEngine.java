...
import Voter2GroupVoters.initfwd.hipe.engine.actor.NotificationActor;
import Voter2GroupVoters.initfwd.hipe.engine.actor.DispatchActor;
...
public class HiPEEngine implements IHiPEEngine{
	...
	public void createJunctionNodes() {
		classes.put("Voter2GroupVoter__FWD_2_localSearch", Voter2GroupVoter__FWD_2_localSearch.class);
		classes.put("Voter2Group__FWD_7_localSearch", Voter2Group__FWD_7_localSearch.class);
		classes.put("VoterRelation2VoterGroupRelation__FWD_16_localSearch", VoterRelation2VoterGroupRelation__FWD_16_localSearch.class);
	}
