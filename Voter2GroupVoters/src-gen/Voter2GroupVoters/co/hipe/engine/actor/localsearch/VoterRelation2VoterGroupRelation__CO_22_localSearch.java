...
public class VoterRelation2VoterGroupRelation__CO_22_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new CachedEdgeExplorer(this, 0, 6, edge_explorer_11_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__CO_production"), this::returnTrue , 0  , false ));
	}
