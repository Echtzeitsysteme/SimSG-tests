...
public class Container2GroupVotersContainer__CO_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Container2GroupVotersContainer__CO_production"), this::returnTrue  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "Container2GroupVotersContainer__CO_2": 
				...
				break;
			case "Container2GroupVotersContainer__CO_3": 
				...
				break;
			case "Container2GroupVotersContainer__CO_4": 
