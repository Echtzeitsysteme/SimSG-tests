package Voter2GroupVoters.sync.hipe.engine.actor.localsearch;
...
public class VoterRelation2VoterGroupRelation__CONSISTENCY_63_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__SRC__v();
						edge_explorer = new CachedEdgeExplorer(this, 9, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__CORR__v2gv();
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCREATE__TRG__group();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getSource();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((Voter.Voter1) o).getLink();
						edge_explorer_6 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((GroupVoters.Voter1) o).getMember();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__TRG__gV();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__SRC__v2();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__CORR__v2gv2();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getSource();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCREATE__CORR__v2g1();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getTarget();
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getSource();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__TRG__gV2();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getSource();
						edge_explorer_19 = new CachedEdgeExplorer(this, 5, 0, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
						edge_explorer_20 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCREATE__CORR__v2g2();
						edge_explorer_21 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_21_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_17_1_orchestration = initializeOrchestration(node.getOrchestrations().get(25).getPlan());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_64": 
				if(true) {
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// v
					HMatch match_0 = new LocalSearchMatch(10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// v2
					HMatch match_1 = new LocalSearchMatch(10);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_5_2_orchestration, match_1);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_66": 
				if(true) {
					edge_explorer_7.registerSourceObject(objs[0]);
					
					// gV
					HMatch match_2 = new LocalSearchMatch(10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_7_1_orchestration, match_2);
					edge_explorer_8.registerSourceObject(objs[0]);
					
					// gV2
					HMatch match_3 = new LocalSearchMatch(10);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_8_1_orchestration, match_3);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_68": 
				if(true) {
					
					// group
					HMatch match_4 = new LocalSearchMatch(10);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_1_orchestration, match_4);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_69": 
				if(true) {
					...
					start(edge_explorer_14_1_orchestration, match_5);
					...
					start(edge_explorer_17_1_orchestration, match_6);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_71": 
				if(true) {
					edge_explorer_12.registerSourceObject(objs[0]);
					edge_explorer_13.registerSourceObject(objs[0]);
					
					// v2gv
					HMatch match_7 = new LocalSearchMatch(10);
					...
					// v2gv2
					HMatch match_8 = new LocalSearchMatch(10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_5_1_orchestration, match_8);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_73": 
				if(true) {
					...
					// VoterRelation2VoterGroupRelation_eMoflon_ProtocolNode
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__SRC__v_Voter1": 
			{
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__CORR__v2gv_Voter2GroupVoter": 
			{
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CREATE__TRG__group_Group": 
			{
		...
		case "Voter1_member_Group": 
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__TRG__gV_Voter1": 
			{
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__SRC__v2_Voter1": 
			{
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__CORR__v2gv2_Voter2GroupVoter": 
			{
		...
		case "Voter2GroupVoter_target_Voter1": 
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CREATE__CORR__v2g1_Voter2Group": 
			{
		...
		case "Voter2Group_source_Voter1": 
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CONTEXT__TRG__gV2_Voter1": 
			{
			...
			break;
		case "VoterRelation2VoterGroupRelation__Marker_CREATE__CORR__v2g2_Voter2Group": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register VoterRelation2VoterGroupRelation_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister VoterRelation2VoterGroupRelation_eMoflon_ProtocolNode
		Collection<HMatch> matches_9 = obj2matches.get(objs[9]);
		if(matches_9 != null) {
