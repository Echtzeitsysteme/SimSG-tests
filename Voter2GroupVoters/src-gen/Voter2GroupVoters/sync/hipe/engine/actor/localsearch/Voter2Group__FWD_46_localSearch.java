...
public class Voter2Group__FWD_46_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 5, 2, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 7, 4, edge_explorer_9_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Voter2Group__FWD_production"), this::returnTrue , 0  , false ));
	}
		...
		switch(msg.patternName) {
			...
			case "Voter2Group__FWD_53": 
				if(true) {
					...
					// v2gv2
					HMatch match_7 = new LocalSearchMatch(8);
		...
		case "Voter2Group_source_Voter1": 
			{
				...
				HMatch match = new LocalSearchMatch(8);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
