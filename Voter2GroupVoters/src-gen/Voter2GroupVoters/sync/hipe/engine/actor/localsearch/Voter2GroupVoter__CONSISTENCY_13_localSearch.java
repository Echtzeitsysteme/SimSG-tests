...
public class Voter2GroupVoter__CONSISTENCY_13_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__TRG__gV();
						edge_explorer = new CachedEdgeExplorer(this, 6, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__CORR__v2gv();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__SRC__c();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((GroupVoters.GroupVotersContainer) o).getVoter();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof GroupVoters.GroupVotersContainer) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__SRC__v();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getTarget();
						edge_explorer_9 = new CachedEdgeExplorer(this, 5, 2, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__CORR__c2gvc();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getSource();
						edge_explorer_11 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__TRG__gvc();
						edge_explorer_12 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((Voter.Container) o).getVoters();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof Voter.Container) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Voter2GroupVoter__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			...
			case "Voter2GroupVoter__CONSISTENCY_20": 
				...
				// Voter2GroupVoter_eMoflon_ProtocolNode
				HMatch match_6 = new LocalSearchMatch(7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Voter2GroupVoter__Marker_CREATE__TRG__gV_Voter1": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch(7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
			...
			break;
		case "Voter2GroupVoter__Marker_CREATE__CORR__v2gv_Voter2GroupVoter": 
			{
			...
			break;
		case "Voter2GroupVoter__Marker_CONTEXT__SRC__c_Container": 
			{
		...
		case "Voter2GroupVoter_source_Voter1": 
			...
			break;
		case "GroupVotersContainer_voter_Voter1": 
			{
				HMatch match = new LocalSearchMatch(7);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
			...
			break;
		case "Voter2GroupVoter__Marker_CREATE__SRC__v_Voter1": 
			{
		...
		case "Voter2GroupVoter_target_Voter1": 
			...
			break;
		case "Voter2GroupVoter__Marker_CONTEXT__CORR__c2gvc_Container2GroupVotersContainer": 
			{
		...
		case "Container2GroupVotersContainer_source_Container": 
			...
			break;
		case "Voter2GroupVoter__Marker_CONTEXT__TRG__gvc_GroupVotersContainer": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register Voter2GroupVoter_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister Voter2GroupVoter_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof GroupVoters.Voter1) {
			HMatch match_2 = new LocalSearchMatch(7);
	...
	public boolean constraint_checker_method(HMatch match) {
		Voter.Voter1 v = (Voter.Voter1) match.getNodes()[1];
		GroupVoters.Voter1 gV = (GroupVoters.Voter1) match.getNodes()[2];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_0 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, v.isVote(), "boolean"));
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, gV.isVote(), "boolean"));
		csp_0.solve();
