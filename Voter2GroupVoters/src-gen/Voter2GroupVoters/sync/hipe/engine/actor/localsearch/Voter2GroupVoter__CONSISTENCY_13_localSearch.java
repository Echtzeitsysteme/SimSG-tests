...
public class Voter2GroupVoter__CONSISTENCY_13_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getSource();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getTarget();
						edge_explorer_7 = new CachedEdgeExplorer(this, 5, 2, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__SRC__v();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__CORR__v2gv();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__TRG__gvc();
						edge_explorer_10 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__CORR__c2gvc();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((Voter.Container) o).getVoters();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof Voter.Container) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 0, 1, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((GroupVoters.GroupVotersContainer) o).getVoter();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof GroupVoters.GroupVotersContainer) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_13 = new EdgeExplorer(this, 3, 2, edge_explorer_13_methods);
