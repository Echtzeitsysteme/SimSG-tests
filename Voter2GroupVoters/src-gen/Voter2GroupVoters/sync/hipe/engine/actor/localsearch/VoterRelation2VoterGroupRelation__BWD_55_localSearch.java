...
public class VoterRelation2VoterGroupRelation__BWD_55_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new CachedEdgeExplorer(this, 0, 6, edge_explorer_6_methods);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__BWD_56": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__BWD_58": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__BWD_60": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__BWD_62": 
