...
public class Voter2Group__CONSISTENCY_32_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__TRG__gV2();
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__TRG__group();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__CORR__v2gv();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getSource();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.multi_lookup = (o) -> ((GroupVoters.Voter1) o).getMember();
						edge_explorer_15 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						...
						edge_explorer_20 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__SRC__v2();
						edge_explorer_21 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_21_methods);
		...
		switch(msg.patternName) {
			case "Voter2Group__CONSISTENCY_33": 
				if(true) {
					...
					start(edge_explorer_13_1_orchestration, match_1);
				}
				break;
