...
public class Voter2Group__CONSISTENCY_32_localSearch extends GenericLocalSearchActor{
	...
	SearchOrchestration edge_explorer_10_2_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__SRC__v2();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__CORR__v2gv();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCREATE__CORR__v2g2();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((Voter.Voter1) o).getLink();
						edge_explorer_9 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__SRC__v();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group__Marker) o).getCONTEXT__TRG__gV2();
						edge_explorer_14 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.multi_lookup = (o) -> ((GroupVoters.Voter1) o).getMember();
						edge_explorer_19 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_19_methods);
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
						edge_explorer_21 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_21_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_10_2_orchestration = initializeOrchestration(node.getOrchestrations().get(16).getPlan());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			...
			case "Voter2Group__CONSISTENCY_35": 
				...
				start(edge_explorer_10_2_orchestration, match_3);
				break;
			case "Voter2Group__CONSISTENCY_37": 
				...
				start(edge_explorer_15_1_orchestration, match_4);
				break;
