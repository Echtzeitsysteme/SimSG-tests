...
public class VoterRelation2VoterGroupRelation__CONSISTENCY_51_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__CORR__v2gv2();
						edge_explorer = new CachedEdgeExplorer(this, 9, 8, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getSource();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__CORR__v2gv();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCREATE__CORR__v2g2();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getSource();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__SRC__v();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getSource();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getSource();
						edge_explorer_10 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((GroupVoters.Voter1) o).getMember();
						edge_explorer_12 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((Voter.Voter1) o).getLink();
						edge_explorer_14 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__SRC__v2();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCREATE__CORR__v2g1();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2Group) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Voter2GroupVoters.VoterRelation2VoterGroupRelation__Marker) o).getCONTEXT__TRG__gV2();
						edge_explorer_19 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getTarget();
						edge_explorer_20 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.multi_lookup = (o) -> ((GroupVoters.Voter1) o).getMember();
						edge_explorer_21 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_21_methods);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_52": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_54": 
				if(true) {
					...
					start(edge_explorer_19_1_orchestration, match_3);
				}
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_56": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_57": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_59": 
				if(true) {
				...
				break;
			case "VoterRelation2VoterGroupRelation__CONSISTENCY_61": 
				if(true) {
