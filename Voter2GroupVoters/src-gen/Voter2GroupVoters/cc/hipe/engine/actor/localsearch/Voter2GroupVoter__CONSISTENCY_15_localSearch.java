...
public class Voter2GroupVoter__CONSISTENCY_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__SRC__c();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__CORR__v2gv();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__TRG__gV();
						edge_explorer_8 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((GroupVoters.GroupVotersContainer) o).getVoter();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof GroupVoters.GroupVotersContainer) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13 = new CachedEdgeExplorer(this, 5, 1, edge_explorer_13_methods);
