...
public class Voter2GroupVoter__CONSISTENCY_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((Voter.Container) o).getVoters();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof Voter.Container) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__TRG__gV();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__CORR__c2gvc();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCONTEXT__TRG__gvc();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getSource();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter) o).getSource();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__CORR__v2gv();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Voter2GroupVoter__Marker) o).getCREATE__SRC__v();
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			...
			case "Voter2GroupVoter__CONSISTENCY_20": 
				...
				break;
			case "Voter2GroupVoter__CONSISTENCY_21": 
				...
				break;
			case "Voter2GroupVoter__CONSISTENCY_22": 
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, v.isVote(), "boolean"));
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, gV.isVote(), "boolean"));
		csp_1.solve();
