...
public class VoterRelation2VoterGroupRelation__CC_43_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 6, edge_explorer_3_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__CC_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__CC_44": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__CC_46": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__CC_48": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__CC_50": 
