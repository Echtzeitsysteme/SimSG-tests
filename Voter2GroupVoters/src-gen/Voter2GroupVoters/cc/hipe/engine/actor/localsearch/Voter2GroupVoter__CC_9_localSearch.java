...
public class Voter2GroupVoter__CC_9_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer) o).getSource();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Voter2GroupVoter__CC_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "Voter2GroupVoter__CC_10": 
				
				// c
				HMatch match_0 = new LocalSearchMatch(5);
				match_0.getNodes()[0] = objs[0];
				start(edge_explorer_1_orchestration, match_0);
				break;
			case "Voter2GroupVoter__CC_11": 
				edge_explorer_3.registerSourceObject(objs[0]);
				edge_explorer_5.registerSourceObject(objs[0]);
				
				// c2gvc
				HMatch match_1 = new LocalSearchMatch(5);
				match_1.getNodes()[1] = objs[0];
				start(edge_explorer_3_1_orchestration, match_1);
				break;
			case "Voter2GroupVoter__CC_12": 
				
				// gvc
				HMatch match_2 = new LocalSearchMatch(5);
				match_2.getNodes()[2] = objs[0];
				start(edge_explorer_3_2_orchestration, match_2);
				break;
			case "Voter2GroupVoter__CC_13": 
				
				// v
				HMatch match_3 = new LocalSearchMatch(5);
				match_3.getNodes()[3] = objs[0];
				start(edge_explorer_2_orchestration, match_3);
				break;
			case "Voter2GroupVoter__CC_14": 
				
				// gV
				HMatch match_4 = new LocalSearchMatch(5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Container_voters_Voter1": 
			{
				HMatch match = new LocalSearchMatch(5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		Voter.Voter1 v = (Voter.Voter1) match.getNodes()[3];
		GroupVoters.Voter1 gV = (GroupVoters.Voter1) match.getNodes()[4];
