...
public class Voter2GroupVoter__FWD_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Voter2GroupVoter__CONSISTENCY_18_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Voter2GroupVoter__FWD_production"), this::returnTrue  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			...
			case "Voter2GroupVoter__FWD_17": 
				...
				break;
			case "Voter2GroupVoter__SRC_12": 
				if(pac_explorer.register(match)) {
					HMatch acMatch_0 = new LocalSearchMatch(4);
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register Voter2GroupVoter__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister Voter2GroupVoter__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[3];
