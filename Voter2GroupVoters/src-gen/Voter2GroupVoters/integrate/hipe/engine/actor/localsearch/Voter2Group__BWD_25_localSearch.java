...
public class Voter2Group__BWD_25_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new CachedEdgeExplorer(this, 6, 3, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_5_methods);
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2}), node.getAllOverlaps().get(0));
	...
	protected void initializeOrchestration() {
		...
		pac_explorer_orchestration = initializeOrchestration(node.getOrchestrations().get(14).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("Voter2Group__BWD_production"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("Voter2Group__CONSISTENCY_41_localSearch"), this::returnTrue  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			...
			case "Voter2Group__BWD_29": 
				...
				break;
			case "Voter2Group__TRG_21": 
				if(pac_explorer.register(match)) {
					HMatch acMatch_0 = new LocalSearchMatch(8);
