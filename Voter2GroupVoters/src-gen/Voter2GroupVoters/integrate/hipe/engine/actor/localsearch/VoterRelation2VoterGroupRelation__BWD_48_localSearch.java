...
public class VoterRelation2VoterGroupRelation__BWD_48_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__CONSISTENCY_61_localSearch"), this::returnTrue  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__BWD_49": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__BWD_51": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__TRG_44": 
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register VoterRelation2VoterGroupRelation__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister VoterRelation2VoterGroupRelation__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
