...
public class Container2GroupVotersContainer__CONSISTENCY_3_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__CORR__c2gvc();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__TRG__gvc();
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__SRC__c();
