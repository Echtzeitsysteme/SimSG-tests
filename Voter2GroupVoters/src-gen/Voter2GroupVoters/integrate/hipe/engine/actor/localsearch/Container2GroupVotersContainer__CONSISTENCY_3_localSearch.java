...
public class Container2GroupVotersContainer__CONSISTENCY_3_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__TRG__gvc();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__SRC__c();
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Voter2GroupVoters.Container2GroupVotersContainer__Marker) o).getCREATE__CORR__c2gvc();
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "Container2GroupVotersContainer__CONSISTENCY_4": 
			...
			case "Container2GroupVotersContainer__CONSISTENCY_5": 
				...
				break;
			case "Container2GroupVotersContainer__FWD_2": 
				...
				break;
			case "Container2GroupVotersContainer__BWD_1": 
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register Container2GroupVotersContainer__FWD
		...
		// register Container2GroupVotersContainer__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister Container2GroupVotersContainer__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister Container2GroupVotersContainer__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(1);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		Collection<HMatch> oMatches_1 = overlap2matches_1.get(oMatch_1);
