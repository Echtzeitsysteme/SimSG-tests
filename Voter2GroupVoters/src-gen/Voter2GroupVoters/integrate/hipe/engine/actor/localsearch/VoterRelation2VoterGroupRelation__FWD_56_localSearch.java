...
public class VoterRelation2VoterGroupRelation__FWD_56_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_3_methods);
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {2,3}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__CONSISTENCY_61_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("VoterRelation2VoterGroupRelation__FWD_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(msg.patternName) {
			case "VoterRelation2VoterGroupRelation__FWD_57": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__FWD_59": 
				...
				break;
			case "VoterRelation2VoterGroupRelation__SRC_53": 
				if(pac_explorer.register(match)) {
					HMatch acMatch_0 = new LocalSearchMatch(6);
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register VoterRelation2VoterGroupRelation__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister VoterRelation2VoterGroupRelation__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
