...
/**
 * A match for the rule <code>newVoterFalse()</code>.
 */
public class NewVoterFalseMatch extends GraphTransformationMatch<NewVoterFalseMatch, NewVoterFalseRule> {
	...
	/**
	 * Creates a new match for the rule <code>newVoterFalse()</code>.
	 * 
	 * @param pattern
	 *            the pattern
	 * @param match
	 *            the untyped match
	 */
	public NewVoterFalseMatch(final NewVoterFalseRule pattern, final IMatch match) {
		super(pattern, match);
