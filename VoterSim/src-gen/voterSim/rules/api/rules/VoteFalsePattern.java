...
import Voter.Voter1;
import voterSim.rules.api.matches.VoteFalseMatch;
import voterSim.rules.api.RulesAPI;

/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@7ce1bbcc (name: v)] which does the following:
