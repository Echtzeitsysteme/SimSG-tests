...
public class Voter1_link_0_reference extends GenericReferenceActor<Voter.Voter1,Voter.Voter1> {
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, ReferenceNode node) {
		...
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(0), getSelf(), name2actor.get("agree_1_junction"), this::check_constraint_1 , 0   ));
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(1), getSelf(), name2actor.get("agree_1_junction"), this::check_constraint_2 , 1   ));
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(2), getSelf(), name2actor.get("connectedV1V3_6_junction"), this::check_constraint_3 , 2   ));
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(3), getSelf(), name2actor.get("connectedV1V3_6_junction"), this::check_constraint_4 , 3   ));
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(4), getSelf(), name2actor.get("convert_11_junction"), this::check_constraint_5 , 4   ));
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(5), getSelf(), name2actor.get("convert_11_junction"), this::check_constraint_6 , 5   ));
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(6), getSelf(), name2actor.get("disagree_16_junction"), this::check_constraint_7 , 6   ));
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(7), getSelf(), name2actor.get("disagree_16_junction"), this::check_constraint_8 , 7   ));
		ports.add(new PortEdgeLeft(node.getPorts().getPort().get(8), getSelf(), name2actor.get("switching_34_junction"), this::check_constraint_13 , 8   ));
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(9), getSelf(), name2actor.get("switching_34_junction"), this::check_constraint_14 , 9   ));
	}	
