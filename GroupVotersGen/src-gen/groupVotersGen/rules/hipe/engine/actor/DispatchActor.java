...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		feature2addEdgeConsumer.put(GroupVoters.GroupVotersPackage.eINSTANCE.getVoter1_Member(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Voter1_member_4_reference").tell(new ReferenceAdded<GroupVoters.Voter1, GroupVoters.Group>(incUtil,(GroupVoters.Voter1) notification.getNotifier(), (GroupVoters.Group) notification.getNewValue(), "Voter1_member_Group"), getSelf());
			incUtil.newMessage();
			name2actor.get("Voter1_member_5_reference").tell(new ReferenceAdded<GroupVoters.Voter1, GroupVoters.Group>(incUtil,(GroupVoters.Voter1) notification.getNotifier(), (GroupVoters.Group) notification.getNewValue(), "Voter1_member_Group"), getSelf());
		});
	}
	...
	private void initializeRemoveEdge() {
		feature2removeEdgeConsumer.put(GroupVoters.GroupVotersPackage.eINSTANCE.getVoter1_Member(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("Voter1_member_4_reference").tell(new ReferenceDeleted<GroupVoters.Voter1, GroupVoters.Group>(incUtil, (GroupVoters.Voter1) notification.getNotifier(), (GroupVoters.Group) notification.getOldValue(), "Voter1_member_Group"), getSelf());
			incUtil.newMessage();
			name2actor.get("Voter1_member_5_reference").tell(new ReferenceDeleted<GroupVoters.Voter1, GroupVoters.Group>(incUtil, (GroupVoters.Voter1) notification.getNotifier(), (GroupVoters.Group) notification.getOldValue(), "Voter1_member_Group"), getSelf());
		});
	}
	...
	private void handleRemoveAdapter(Notification notification) {
		...
		if (node instanceof GroupVoters.Voter1) {
			incUtil.newMessage();
			name2actor.get("Voter1_object_SP2").tell(new ObjectDeleted<GroupVoters.Voter1>(incUtil, (GroupVoters.Voter1) node), getSelf());
		}
		...
		if (node instanceof GroupVoters.Group) {
			incUtil.newMessage();
			name2actor.get("Group_object_SP2").tell(new ObjectDeleted<GroupVoters.Group>(incUtil, (GroupVoters.Group) node), getSelf());
		}
	}
}
