...
import groupVotersGen.rules.api.matches.TrueMemberVGMatch;
...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@462b282b (name: g), org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@1103cd85 (name: v)] which does the following:
...
public class TrueMemberVGPattern extends GraphTransformationPattern<TrueMemberVGMatch, TrueMemberVGPattern> {
	 ...
	 *            the object to set
	 */
	public TrueMemberVGPattern bindV(final Voter1 object) {
	 ...
	 *            the object to set
	 */
	public TrueMemberVGPattern unbindV() {
		parameters.remove("v");
		return this;
	}
