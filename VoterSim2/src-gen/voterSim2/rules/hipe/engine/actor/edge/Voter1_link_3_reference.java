...
public class Voter1_link_3_reference extends GenericReferenceActor<Voter.Voter1,Voter.Voter1> {

	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, ReferenceNode node) {
		ports = new LinkedList<>();
		ports.add(new PortEdgeRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("agreeTrue_6_junction"), this::check_constraint_8 , 0   ));
	}	
