...
public class Voter1_object_SP1 extends GenericObjectActor<Voter.Voter1> {
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, ObjectNode node) {
		...
		ports.add(new PortNodeMatch<Voter.Voter1>(node.getPorts().getPort().get(1), getSelf(), name2actor.get("voteFalse_production"), this::check_constraint_14 , 0   , node.getName() ));
	}
	
	public boolean check_constraint_14(Voter.Voter1 v, int index) {
