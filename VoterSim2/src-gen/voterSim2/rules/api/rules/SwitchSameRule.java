...
import Voter.Voter1;
import voterSim2.rules.api.matches.SwitchSameMatch;
...
public class SwitchSameRule extends GraphTransformationRule<SwitchSameMatch, SwitchSameRule> {
	...
	public SwitchSameRule(final RulesAPI api, final GraphTransformationInterpreter interpreter) {
		super(api, interpreter, patternName, Optional.of(new StaticProbability<SwitchSameMatch, SwitchSameRule>(interpreter, 0.2, 0.0, IBeXDistributionType.STATIC, OptionalDouble.empty())));
	}
